THE IDL ASTRONOMY USER'S LIBRARY (May 2015)
...
The following subdirectories are available
  ...
  pro/coyote - Contains Coyote Library routines which are needed by at least one 
  ...
  pro/markwardt - Contains the procedures from the Markwardt library which are used
  ...
  v84 - A beta test directory of procedures using new features in IDL V8.4
